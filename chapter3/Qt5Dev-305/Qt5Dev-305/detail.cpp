...
Detail::Detail(QWidget * parent /* = 0 */) :QWidget(parent)
{
	...
	mainLayout->addWidget(CityTextEdit, 2, 1);
	mainLayout->addWidget(IntroductLabel, 3, 1);
	mainLayout->addWidget(IntroductTextEdit, 3, 2);
